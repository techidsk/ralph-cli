...
RALPH_REVIEW_MODEL="${RALPH_REVIEW_MODEL:-claude-haiku-4-5-20251001}"

# 执行限制
RALPH_MAX_TURNS_SIMPLE="${RALPH_MAX_TURNS_SIMPLE:-25}"
RALPH_MAX_TURNS_COMPLEX="${RALPH_MAX_TURNS_COMPLEX:-40}"
...
# 验证失败自动修复: Claude 最大 turns 数
RALPH_VERIFY_FIX_MAX_TURNS="${RALPH_VERIFY_FIX_MAX_TURNS:-20}"
